            ...
            <Container>
                <Form>
                    ...
                    <Form.Group widths='equal'>
                        ...
                        <Form.Select fluid label='State' options={stateOptions} placeholder='Select State' />
                    </Form.Group>
                    <Form.Group widths='equal'>
                        <Form.Input fluid label='Zip Code' placeholder='Zip Code' />
                        <Form.Select fluid label='Country' options={countryOptions} placeholder='Select Country' />
                    </Form.Group>
                    <Form.Group widths='equal'>
                        <Form.Input fluid label='First name' placeholder='First name' />
                        <Form.Input fluid label='Last name' placeholder='Last name' />
