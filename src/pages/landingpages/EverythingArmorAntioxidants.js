      ...
      <Container>
        <Grid container>
          <Grid item xs={12} md={8} className="smaller-container">
            ...
            <p>
              Antioxidants are compounds that help combat oxidation (the process that causes iron to rust and cut apples to turn brown), which is where they get their name—anti-oxidant. And yes, oxidation in your body is every bit as cringe worthy as rusted iron and brown apples.
            </p>
            <p>
              In fact, it’s one of the biggest underlying causes of nearly all the negative health aspects of aging. No wonder so many baby boomers have started calling the “golden years” the “rusting years.”
            </p>
            <p>
              So if antioxidants are among the few things we know can help our bodies resist oxidation, it makes sense to get more of them, right? Absolutely. But some antioxidants work better than others, and a little-known antioxidant called astaxanthin (as-ta-zan-thin) is proving to be far more effective than the rest.
            </p>
            ...
            <div className="floating">
              ...
              <p>
                AAstaxanthin essentially creates an antioxidant force field of protection for the algae—and scientists think this survival mechanism provides a clue as to how astaxanthin can help protect our cells, too.
              </p>
          ...
          <Grid item xs={12} md={6} className="smaller-container">
            <div className="large-checklist">
              <ul className="large-ul">
                <li>
                  Astaxanthin has been shown to <b>help deliver oxygen to muscle cells that need it during exercise.</b>
                </li>
                <li>
                  Astaxanthin enhances the energy-producing capacity of your cells’ mitochondria, helping to{' '}
                  <b>boost your energy during exercise and throughout the day.</b>
                </li>
                <li>
                  Astaxanthin reduced levels of lactic acid (the metabolite that really causes you to "feel the burn”)
                  during exercise by <b>28.6</b>%.
                </li>
                <li>
                  Astaxanthin increased muscle endurance in men, enabling them to perform <b>62% more knee bends</b>{' '}
                  while carrying a 90-pound weight!
                </li>
                <li>
                  Astaxanthin improved the cycling performance of competitive male endurance cyclists,{' '}
                  <b>shaving two minutes off their time</b> in a 20-kilometer trial!
                </li>
              </ul>
            </div>
          </Grid>
