...
const FastAsleepLifestyle = ({ history, location }) => {
  ...
  useEffect(() => {
    window.analytics.page('FastAsleepLifestyle');
  ...
  return (
    <div className="landing-page-design">
      ...
      <Container>
        <Grid container>
          <Grid item xs={12} md={8} className="smaller-container">
            <h1>Fall asleep faster. Stay asleep longer. Wake up feeling amazing.</h1>
            <h3>Get the sweetest sleep of your life—with the new non-melatonin sleep solution</h3>
          </Grid>
        </Grid>
        <Grid container>
      ...
      <Container>
        ...
        <Grid container>
          <Grid item xs={12} md={8} className="smaller-container">
            <h2>Your sweetest (sugar-free) sleep ever </h2>
            <p>
        ...
        <Grid container>
          <Grid item xs={12} md={10} className="smaller-container">
            <div className="wake-up-box">
              <img
                className="hidden-xs"
                src="https://images.ctfassets.net/mj9bpefl6wof/4pOZp8G5Qk4w8uP6x47Aqs/d02235ff6215ff8ba83029abb4d7a964/FA_-_desktop.png?w=900"
              />
...
export default FastAsleepLifestyle;
