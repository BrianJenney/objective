      ...
      <Container>
        <Grid container>
          <Grid item xs={12} md={8} className="smaller-container">
            <h1>Forget Melatonin.</h1>
            <h3>Discover the non-hormonal solution that can help you sleep AND feel less stressed</h3>
          </Grid>
        </Grid>
        <Grid container>
        ...
        <Grid container>
          <Grid item xs={12} md={6} className="smaller-container">
            <div className="cta-holder">
              ...
              {/* <NavLink onClick={handleAddToCart} className="green-btn">
              get 15% off — Buy Now
              </NavLink> */}
            </div>
          </Grid>
...
export default FastAsleepMelatonin;
