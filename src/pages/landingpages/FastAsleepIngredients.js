      ...
      <Grid container>
        <Grid item xs={12} md={8} className="smaller-container">
          <div className="floating">
            <div className="beige-box float-right benefits">
            ...
            <p>
              There’s no way around it: You need to sleep—and you need to sleep well—to feel well, perform at your best
              during the day and, yes, even look good doing it.<sup>*</sup>
            </p>
            <p>
              But if you’re among the estimated 50-70 million Americans who struggle with occasional sleeplessness, know
              that sleeping well is easier said than done.<sup>1</sup>
            </p>
            <p>
              Whether your mind starts racing as soon as your head hits the pillow… or you find yourself wide awake in
              the middle of the night worrying about your to-do list, tossing and turning when you “should” be sleeping…
              or you wake up feeling exhausted yet again after spending all night in bed “trying to sleep,” not sleeping
              is NOT OK.<sup>*</sup>
            </p>
            <p>
              Aside from daytime drowsiness, lack of focus and reduced productivity, missing out on high-quality sleep
              can have serious implications for your health, ranging from weight gain to increased cardiovascular risk.
              <sup>*</sup>
            </p>
            <p>
              And it’s NOT melatonin—it’s a revolutionary new solution that combines a calming neurotransmitter known as
              GABA (in amino acid form) with an extract made from the aromatic spice saffron. These two powerful, yet
              gentle, clinically studied ingredients help counteract the negative effects of stress to promote deep,
              restorative sleep.<sup>3-16*</sup>
            </p>
          </div>
          <hr />
          <h2>GABA: The calming neurotransmitter</h2>
          <p>
          ...
          <div className="floating">
            ...
            <p>
              GABA’s primary jobs are to reduce the activity of nerve cells throughout your nervous system and help your
              mind move from the wakeful state to the sleeping state. By inhibiting neural activity, GABA reduces mental
              and physical stress, eases feelings of anxiousness, creates a calmness of mood and induces sleep.
              <sup>3-10*</sup>
            </p>
            <p>
          ...
          <p>
            When GABA’s calming effects on the nervous system were first revealed in the research, many companies raced
            to market with synthetic GABA supplements, which didn’t yield great results. But then a new form of GABA
            came on to the scene. Called PharmaGABA®, it’s produced by fermentation using the same friendly probiotic
            (Lactobacilllus hilgardi) used to culture the traditional Korean fermented food, kimchi.
            <sup>5*</sup>
          </p>
          <p>
            PharmaGABA® has been shown to effectively increase the alpha-wave brain activity associated with calmness
            and relaxation while decreasing the beta-wave activity linked with nervousness and feelings of anxiousness.
            <sup>6,7*</sup>
          </p>
          <p>
            In a small 7-day study, PharmaGABA® reduced the time it took study participants to fall asleep and increased
            sleep quality and efficiency (the amount of time asleep while in bed), according to Pittsburgh Sleep Quality
            Index (PSQI) scores. Participants also reported improvements in the way they felt upon waking.<sup>8*</sup>
          </p>
          <p>
            In a second 4-week study with healthy older adults, participants reported improved sleep and less drowsiness
            in the morning, along with a welcomed decrease in nighttime urination.<sup>9*</sup>
          </p>
          <p>
          ...
          <hr />
          <h2>Saffron: The natural sleep aid worth its weight in gold</h2>
          <p>
          ...
          <div className="floating">
            <div className="beige-box float-left adds">
            ...
            <p>
              Harvested by hand, each delicate thread must be carefully removed from the center of the flower. It takes
              more than 12,000 individual stigmas to produce a single ounce of saffron. But it's truly worth its weight
              in gold (especially for the sleep-deprived among us)!<sup>*</sup>
            </p>
            <p>
              ...
              levels of the stress hormone cortisol, and can help balance levels of important mood- and sleep-regulating
              brain chemicals like serotonin, dopamine and glutamate.11-16<sup>*</sup>
            </p>
          </div>
          <h2>The clinical results are solid (gold)</h2>
          <p>
            With issues around sleep, stress, anxiousness and mood affecting more and more of us these days, researchers
            are excited about saffron’s potential to help. Multiple clinical trials have demonstrated saffron’s
            mood-enhancing effects, but two are particularly notable.<sup>14,15*</sup>
          </p>
          <p>
            Both studies investigated the effects of a 30 mg/day dose of saffron extract on mood. By the end of the six-
            and eight-week study periods, the study participants taking saffron experienced dramatic, statistically
            significant improvements in overall mood balance.<sup>14,15*</sup>
          </p>
          <h2>A 100% success rate for better sleep</h2>
          <div className="floating">
            <div className="beige-box float-right saffron">
            ...
            <p>
              Another truly impressive study—a randomized, double-blind, placebo-controlled clinical trial—evaluated the
              effects of a daily dose of 30 mg per day of a standardized saffron extract called Saffr’Activ® on mood,
              anxiousness and sleep in 30 healthy adults.<sup>16*</sup>
            </p>
            <p>
              Over the course of six weeks, the participants answered standardized questionnaires at weekly intervals.
              The saffron group experienced notable improvements in mood and feelings of anxiousness symptoms by the end
              of the study period.<sup>16*</sup>
            </p>
            <p>
              ...
              (that’s everyone, which is almost unheard of in clinical trials) showed improvement in three key measures
              of sleep.<sup>*</sup>
            </p>
          </div>
          ...
          <div className="floating">
            ...
            <p>
              Saffr’ACTIV® is the real deal. It’s made from Crocus sativa saffron flowers grown in North Africa, Greece
              and the Middle East.<sup>*</sup>
            </p>
            <p>
              The flowers are collected by hand in the fall, early in the morning when they are just starting to open.
              This ensures that 1) the energy of the plant and its biologically active compounds are concentrated in the
              flower and; 2) the delicate stigmas are protected inside the flower’s still mostly closed petals.
              <sup>*</sup>
            </p>
            <p>
          ...
          <p>
            From weird, disturbing dreams and morning grogginess to interfering with your body’s sleep-wake rhythm, the
            sleep-inducing hormone melatonin has some pretty significant drawbacks.<sup>2*</sup>
          </p>
          <p>
            GABA and saffron, on the other hand, offer side effect-free, non-habit-forming sleep support. And they come
            with powerful mood-boosting, stress-relieving benefits that increase over time, which means sleep that gets
            better and better—and days that get brighter and more productive.<sup>3-16*</sup>
          </p>
      ...
      <Grid container>
        <Grid item xs={12} md={8} className="smaller-container">
          ...
          <div className="floating">
            ...
            />
            <p>
              If you’re like most of us, balancing busy work schedules with kids’ schedules, maintaining a household and
              doing your best to exercise and take care of your body, chances are you don’t have more time to allocate
              for sleep. (When was the last time you took a nap?) So getting as much high-quality sleep as possible
              during the hours you have for sleep is critical to feeling your best during the day.<sup>*</sup>
            </p>
            <p>
          ...
          <p>
            Stress causes a state of hyperarousal that keeps your brain and body “on alert,” which can make it difficult
            to “power down” your brain at night when it’s time to relax and fall asleep. It can also make it hard to
            stay asleep or fall back to sleep after waking up in the middle of the night.<sup>*</sup>
          </p>
          <p>
            To make matters worse, our schedules are often at odds with the natural rhythms of day and night and light
            and dark that our bodies were originally designed for. Artificial light and caffeine often have us working,
            playing, thinking and scrolling around the clock, which layers on even more physical stress.<sup>*</sup>
          </p>
          <h2>7 signs you aren’t getting Enough High-Quality sleep</h2>
          <p>
          ...
          <p>
            <strong>1. Daytime drowsiness:</strong> This one might seem obvious, but it can be serious and can even lead
            to impaired driving.<sup>*</sup>
          </p>
          <p>
          ...
          <p>
            <strong>6. Impaired immune function:</strong> Your immune system works while you sleep, and not getting the
            sleep you need makes it harder for it to do its job.<sup>*</sup>
          </p>
          <p>
            <strong>7. Heart health concerns:</strong> Ongoing lack of sleep has been linked to cardiovascular concerns.
            <sup>*</sup>
          </p>
        </Grid>
      </Grid>
        ...
        <Grid item xs={12} md={8} className="smaller-container">
          ...
          <div className="floating">
            ...
            <p>
              ...
              dark chocolate mint filled with two powerful, natural sleep-inducing ingredients that help counteract the
              negative effects of stress on sleep: GABA and saffron.<sup>*</sup>
            </p>
          ...
          <p>
            Now, thanks to recent scientific advances in our understanding of stress and sleep and innovations in how we
            take supplements, the Objective team is excited to introduce a SWEET new sleep solution that takes natural
            sleep support to the next level.
          </p>
          <p>
          ...
          <p>
            Nearly every sleep solution comes in pill form. Why is that an issue? Because taking pills requires drinking
            water, which just doesn’t make sense right before bed. Why take something to help you sleep only to have
            your bladder wake you up in the middle of the night?<sup>*</sup>
          </p>
          <p>
            That’s why Fast Asleep is a mint dark chocolate that feels like an indulgent bedtime ritual. Fast Asleep is
            naturally sugar-free—it’s sweetened with keto-friendly allulose—and is non-habit-forming, so it’s a nightcap
            you can feel good about! (Yes, dark chocolate does contain trace amounts of caffeine, but you can rest
            assured that it’s a negligible amount and is balanced by the other ingredients.)<sup>*</sup>
          </p>
          <h4>Quality, purity and effectiveness you can trust</h4>
          <p>
            Fast Asleep is manufactured in the U.S. with research-based doses of PharmaGABA® and Saffr’Activ®, which we
            chose because they each have extensive research backing their safety and efficacy. We are meticulous in
          ...
          <hr />
          <h2>Better sleep, guaranteed. Try it today—risk-free!</h2>
          <p>
            The great news about Fast Asleep is that it often starts working the first night you take it. Depending on
            your physiology and sleep habits, it may take up to a week to start seeing the effects, but you’ll KNOW when
            it’s working, because you’ll:<sup>*</sup>
          </p>
        </Grid>
      </Grid>
      <Grid container>
      ...
      <Grid container>
        <Grid item xs={12} md={8} className="smaller-container">
          ...
          <p>
            ...
            sugar-free means that you're not simply getting short-term benefits at the risk of long-term damage to your
            health.<sup>*</sup> Fast Asleep is backed by our industry-leading money-back guarantee. And for a limited
            time, you can try it risk-free with free shipping. If it doesn’t work, don’t lose MORE sleep over it—just
            let us know and we’ll refund your money. No need to return it, give it to a friend to try.
          </p>
