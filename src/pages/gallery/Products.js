                ...
                <div className="opt1">
                  <Grid container className="gallery-content-blurb">
                    <Grid item xs={12} md={5} className="leftside">
                      ...
                      <p>
                        This year, feel sharper, more rested and healthier doing everything you
                        do—our science-backed supplements make it easy. Order today risk-free with
                        our 90-day, 100% refund guarantee.
                      </p>
                    </Grid>
                ...
                <div className="opt1">
                  <Grid container className="gallery-content-blurb">
                    <Grid item xs={12} md={5} className="leftside">
                      ...
                      <Divider variant="fullWidth" />
                      <p>
                        Pair our Fast Asleep chocolate mints with Immune + Wellness gummies to get
                        the deep restorative rest you need at night and the extra immune support you
                        need during the day.*
                      </p>
                    </Grid>
                    <Grid item xs={12} md={7}>
                  ...
                  <div className="opt1">
                    <Grid container className="gallery-content-blurb">
                      <Grid item xs={12} md={5} className="leftside">
                        ...
                        <Divider variant="fullWidth" />
                        <p>
                          Crafted with ingredients aimed to deliver specific results, from better
                  ...
                  <div className="opt1">
                    <Grid container className="gallery-content-blurb">
                      <Grid item xs={12} md={5} className="leftside">
                        ...
                        <Divider variant="fullWidth" />
                        <p>
                          Nourish your skin from within and topically for an even tone and a
